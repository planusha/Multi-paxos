...
public class Learn extends Message {
    ...
    public Learn(NodeIdentifier sender, int slotNumber, HashMap key_value_pair, long proposalNumber, int index) {
        super(MSG_TYPE.Learn, sender);
    ...
    public String toString(){
        ...
        sb.append("Learn<src=").append(super.getSender())
